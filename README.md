...
- **Курант «Курс математического анализа»**
	- **
- **Прекрасные чудовища математики https://habr.com/ru/articles/407883/**
	- *Сказ будет о функции Вайерштраса, которая являет собой фрактальное нечто. Изначально я думал, что такие вещи не встречаются в природе, но, оказывается, что очень даже.*
