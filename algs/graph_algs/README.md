...
# Код портирован с Object Pascal (Delphi) на Python. Взято из книги «Занимательное программирование. Самоучитель» 2005, страницы 145 - 175
# Код дополнен окном с анимацией для отображения последовательности ходов решения (22 июн 25)
