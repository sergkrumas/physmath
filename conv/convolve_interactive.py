...
def rc_response(RC=1.0, t_start=1.0, t_end=4.0):
    # входной прямоугольный сигнал
    u = np.where((t >= t_start) & (t <= t_end), 1.0, 0.0)
...
interact(rc_response, RC=widgets.FloatSlider(value=1.0, min=0.1, max=5.0, step=0.1),
